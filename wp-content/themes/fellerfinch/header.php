...
<div id="page" class="hfeed site">
  <div id="wrap">
	<header id="masthead" class="site-header" role="banner">
		...
		<!-- start hide for small, hide for medium IE Show for Large -->
		<section class="hide-for-small hide-for-medium dark-bg">
			<section class="row large-collapse">
				<section class="columns large-12 medium-6">
						<h1 class="site-title">
							<a data-magellan-arrival="home" href="#home" rel="home"><img src="<?php bloginfo('stylesheet_directory');?>/img/feller-finch2.png" width="163" height="152" alt="<?php bloginfo( 'name' ); ?>"></a>
						</h1>	
						<nav id="primary-navigation" class="columns medium-5 site-navigation primary-navigation" role="navigation">
							<div data-magellan-expedition="fixed" id="magellan-stuff">
								<ul class="sub-nav nav-menu">
									...
									<li class="menu-item" data-magellan-arrival="team"><a href="#team">our team</a></li>
